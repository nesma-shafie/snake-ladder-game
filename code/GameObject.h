...
public:
	...
	void  setposittion(CellPosition pos);   //a setter for position

	// ============ Virtual Functions ============

	virtual void Draw(Output* pOut, int n = 1) const = 0;	 // Draws the game object in the window in his position cell 
