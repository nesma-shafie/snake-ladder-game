...
public:
	...
	void setprevented(bool condition);
	bool getprevented();
	void setNumOfUnplayedTurns(int num); //sets num of the times he will be prevented of playing
	int getNumOfUnplayedTurns();
