...
public:
	...
	void setPlayersTurnCount(int N);
	void setPlayersWallet(int N);
	void setPlayersPosition(int N);
	...
	void loadAllLadders(ifstream& Infile);
	...
	int GetCurrentPlayerNum(Player* p);
